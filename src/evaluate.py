...
if __name__ == "__main__":
    ...
    image_ids       = open(os.path.join(VOCdevkit_path, "VOC811/ImageSets/Segmentation/test.txt"),'r').read().splitlines()
    gt_dir          = os.path.join(VOCdevkit_path, "VOC811/SegmentationClass/")
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            image_path  = os.path.join(VOCdevkit_path, "VOC811/JPEGImages/"+image_id+".jpg")
